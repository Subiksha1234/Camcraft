    ...
    return (
        <>
            ...
            <div className='dashboard-container'>
                <div className='container-fluid d-flex justify-content-center' style={{ width: '95%' }}>
                    <div className="shadow-lg p-3 mb-5 bg-white rounded">
                        <div className="card">
                            <h5 className="card-header">Community Discussion</h5>
                            <div className="card-body text-start">
                                ...
                                <br />
                                <button className="btn btn-primary" onClick={() => {  }}>I Agree</button>
                            </div>
                        </div>
                    </div>
                </div>
